...
# # # tts = TTS(model_name="tts_models/en/vctk/vits")  # Replace with your model name
...
# # # <speak>
# # #     <break time="500ms"/>
# # #     <prosody rate="medium">This is an example. Hello, welcome to this channel.</prosody>
# # # </speak>
# # # """
...
# # )
# # options = TTSOptions(voice="s3://voice-cloning-zero-shot/36e9c53d-ca4e-4815-b5ed-9732be3839b4/samuelsaad/manifest.json")
# # # Open a file to save the audio
# # with open("output_jenn.wav", "wb") as audio_file:
# #     for chunk in client.tts('The dog sat calmly, as if it were a guardian, not a mere pet.', options, voice_engine = 'PlayDialog', protocol='http', streaming=True):
...
data = """{\n   "reading_order": [\n      "Hey, I\'ve seen this one!",\n      "Kanye West\'s honorary college degree has been taken away by The School of The Art Institute of Chicago.",\n      "pop Base @PopBase · 1h",\n      "Pop Base" \n   ]\n}"""
data = data.replace("\n", "")
data = json.loads(data)["reading_order"]
print(data)
